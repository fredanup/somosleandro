...
export default function Main() {
  ...
  return (
    <>
      <div className="m-0 box-border h-screen w-screen border-0 bg-slate-200 drop-shadow-lg rounded-lg md:p-2 md:flex md:flex-row md:h-screen md:w-screen md:gap-2">
        ...
        */}
          ...
          <svg
            viewBox="0 0 512 512"
            className={`h-8 w-8 cursor-pointer fill-black p-1  ${
