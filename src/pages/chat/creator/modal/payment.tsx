  ...
  return (
    <>
      <div>
        ...
        <div className="absolute left-1/2 top-1/2 z-30 w-auto -translate-x-1/2 -translate-y-1/2 transform rounded-lg bg-white p-6 drop-shadow-lg">
          ...
          <button
            ...
            className="mt-4 h-8 w-full rounded-lg bg-green-500 text-white hover:bg-green-400 active:bg-green-300"
          >
            Confirmar
          </button>
          <button
            className="mt-2 h-8 w-full rounded-lg bg-gray-600 text-white hover:bg-gray-500 active:bg-gray-400"
            onClick={onClose}
          >
            Cancelar
          </button>
