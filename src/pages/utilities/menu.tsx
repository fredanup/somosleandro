...
const Menu = ({ optSelected }: { optSelected: number }) => {
  ...
  return (
    <>
       ...
       */}
      <nav
        className={`fixed inset-x-0 bottom-0 z-10 p-1 border-t border-gray-200 flex flex-row bg-white drop-shadow-lg justify-evenly items-center md:static md:flex md:h-full md:flex-col md:border-0`}
      >
