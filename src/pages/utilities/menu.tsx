...
const Menu = ({ optSelected }: { optSelected: number }) => {
  ...
  return (
    <>
       ...
       */}
      <nav
        className={`fixed inset-x-0 bottom-0 z-10 p-1 border-t border-gray-200 flex flex-row bg-white justify-evenly items-center md:rounded-lg md:drop-shadow-lg md:justify-normal md:items-stretch md:static md:flex md:flex-col md:h-full md:border-0 md:gap-8 md:pt-8 md:bg-sky-950`}
      >
        ...
        >
          ...
          <p className="text-gray-500 text-sm cursor-pointer md:text-white">
            Tus posts
          </p>
        </div>
