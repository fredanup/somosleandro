        ...
        <div className="h-screen w-screen bg-white flex flex-row items-end pb-12 justify-center bg-[url('/images/wallpaper.jpg')] bg-cover bg-center">
          ...
          <div className="flex flex-col gap-9 p-9 bg-white rounded-lg drop-shadow-lg opacity-90">
            ...
            <div className="flex flex-col gap-4">
              {/**Botón de inicio */}
              <div
                className="items-center justify-center cursor-pointer flex flex-row gap-4 w-full h-12 rounded-full bg-red-500 text-base font-semibold text-white hover:border-transparent hover:bg-red-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-offset-2"
                onClick={() => {
                  signIn('google').catch(console.log);
                }}
              >
                <svg className="h-6" viewBox="0 0 512 512">
              ...
              <div
                className="items-center justify-center cursor-pointer flex flex-row gap-4 w-full h-12 rounded-full bg-sky-500 text-base font-semibold text-white hover:border-transparent hover:bg-sky-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-sky-400 focus:ring-offset-2"
                onClick={() => {
