                ...
                >
                  ...
                  <div className="ml-auto flex flex-row gap-4">
                    <svg
                      ...
                      onClick={(event) => acceptAppliantStatus(event, entry.id)}
                    >
                    ...
                    <svg
                      ...
                      onClick={(event) => rejectAppliantStatus(event, entry.id)}
                    >
