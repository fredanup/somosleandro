...
export default function CallingSmallScreen({
  ...
  return (
    <>
      ...
      <svg
        viewBox="0 0 512 512"
        className="absolute bottom-12 right-3 z-10 h-10 w-10 -translate-x-1/2 -translate-y-1/2 transform cursor-pointer rounded-lg fill-sky-500 drop-shadow-lg md:bottom-6 md:w-auto"
        onClick={openModal}
      >
