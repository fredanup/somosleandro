    ...
    <>
      {isOpen && (
        <div>
          ...
          <div className="absolute left-1/2 top-1/2 z-20 w-9/12 -translate-x-1/2 -translate-y-1/2 transform flex flex-col gap-2 rounded-lg bg-white p-6 drop-shadow-lg">
